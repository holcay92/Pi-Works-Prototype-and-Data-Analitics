...
def impute_missing_vaccinations(filename):
    ...
    top_countries = df.groupby('country')['daily_vaccinations'].median().nlargest(3).index.tolist()
    print("Top-3 countries with highest median daily vaccination numbers: ", top_countries)
